...
let currentPlayer =1
    ...
    (function(index){
        // add a onclick to each square in your grid
...
// check the board for a win or lose
    function checkBoard(){
        const winningArrays = [[0, 1, 2, 3], [41, 40, 39, 38], [7, 8, 9, 10], [34, 33, 32, 31], [14, 15, 16, 17], [27, 26, 25, 24], [21, 22, 23, 24],[20, 19, 18, 17], [28, 29, 30, 31], [13, 12, 11, 10], [35, 36, 37, 38], [6, 5, 4, 3], [0, 7, 14, 21], [41, 34, 27, 20],
        ...
        // now take the 4 values in each winningArrays and plug them into the square
